...
apt-get -y install --yes --allow-unauthenticated vim nano net-tools \
	...
	php-mysqli php-mysql php7.0-mysql \
	php-xml php7.0-xml php-soap php7.0-soap php-zip php7.0-zip > /dev/null 2>&1
...
TS=$(date +'%T')
SSH_COPIED_PATH="${PROJECT_ROOT}/storage/container_id_rsa_7.0_${DATE}_${TS}"
